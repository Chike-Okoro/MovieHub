package com.example.myfirstproject.database
...
class PaperPrefs: CoroutineScope, LifecycleObserver {
    ...
    companion object{
        ...
        val EMAIL_KEY = "iuwfkomefwomwefsniuffwewfwnnwei"
        ...
        val CUSTOMER_SUPPORT_EMAIL = "fdoikoew"
        val CUSTOMER_SUPPORT_PHONE_NUMBER = "eferoermomre"
        val NAME = "FSOKMWELMW"
        val EARNINGS = "feekfev"
        val FIRSTNAME = "fwejkmnwefom"
        val AUTH = "wiunwfiniwinnf34o3"
    }
